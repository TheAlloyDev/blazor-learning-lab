...
This file holds the next learning tasks for this project.
...
- It keeps future tasks inside the repo.
- It turns learning goals into concrete next actions.
- It gives you a reusable prompt instead of rewriting it later.